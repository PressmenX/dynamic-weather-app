...
export const weatherVariants = cva(
  "flex flex-col items-center mx-auto w-100 px-8 py-4 rounded-4xl shadow-xl shadow-black/70  text-white bg-linear-to-br ",
  {
    variants : {
      weather : {
        clouds : "from-sky-800 via-sky-500 to-gray-300",
        clear : "from-orange-800 via-orange-500 to-gray-300",
        atmosphere : "from-gray-600 via-gray-500 to-gray-300",
